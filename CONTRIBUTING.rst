...
We appreciate help from the community to make Gyrus better.

Filing issues
=============

If you find a bug in Gyrus,
or think that a certain feature is missing,
please consider
`filing an issue <https://github.com/arvoelke/gyrus/issues>`_!
...
If you want to fix a bug or add a feature to Gyrus,
